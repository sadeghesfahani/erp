...
class AI:
    ...
    def add_file(self, file: models.FileField, data):
    ...
    def get_assistant_id():
        return "asst_p4dP9p74U9TT5p2y5q4O9h8F"
    ...
    def process_ai_response(self, run):
        ...
        if run.status == "requires_action":
            ...
            return self.process_ai_response(
                self.client.beta.threads.runs.submit_tool_outputs_and_poll(tool_outputs=function_responses, run_id=run.id,
